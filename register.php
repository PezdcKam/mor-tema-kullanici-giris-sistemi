...
<body>
    ...
    <main class="relative z-10 min-h-screen flex items-center justify-center px-6 py-12">
        <section class="bg-gradient-to-br from-purple-900/70 to-purple-800/60 backdrop-blur-xl rounded-3xl shadow-2xl max-w-md w-full p-10 border border-purple-600/50">
            ...
            <?php if ($success): ?>
                <div class="bg-green-500/20 border border-green-500 text-green-200 px-4 py-3 rounded mb-6">
            ...
            <form method="POST" class="space-y-6" novalidate>
                ...
                <div>
                    <label for="email" class="block text-purple-300 font-semibold mb-2 select-none">
                        E-posta
                    </label>
                    <div class="relative">
                        ...
                        <i class="fas fa-envelope absolute right-3 top-1/2 -translate-y-1/2 text-purple-400 pointer-events-none"></i>
                    </div>
                </div>
                ...
                <div>
                    <label for="confirm-password" class="block text-purple-300 font-semibold mb-2 select-none">
                        Şifre Tekrar
                    </label>
                    <div class="relative">
